...
browser.get('http://www.demo.guru99.com/V4/manager/FundTransInput.php')

elem = browser.find_element_by_name("payersaccount")
elem.send_keys("170220")

elem = browser.find_element_by_name("payeeaccount")
elem.send_keys("170496")
